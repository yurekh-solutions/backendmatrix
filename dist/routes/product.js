...
router.post('/', auth_1.supplierAuth, multer_1.uploadProductImage.single('productImage'), productController.addProduct);
router.get('/my-products', auth_1.supplierAuth, productController.getSupplierProducts);
router.put('/:id', auth_1.supplierAuth, multer_1.uploadProductImage.single('productImage'), productController.updateProduct);
