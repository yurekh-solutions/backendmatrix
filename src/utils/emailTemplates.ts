export const approvalEmailTemplate = (companyName: string, dashboardUrl: string) => `
<!DOCTYPE html>
<html>
<head>
  <style>
...
export const rejectionEmailTemplate = (companyName: string, reason: string, reapplyUrl: string) => `
<!DOCTYPE html>
<html>
<head>
  <style>
